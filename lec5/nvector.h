...
void nvector_add      (nvector* a, nvector* b, nvector* c); /* a_i ← a_i + b_i */
void nvector_sub      (nvector* a, nvector* b, nvector* c); /* a_i ← a_i - b_i */
void nvector_scale    (nvector* v, nvector* c, double x);   /* a_i ← x*a_i     */
/* */
