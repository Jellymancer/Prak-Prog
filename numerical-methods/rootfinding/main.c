...
int main() {
	...
	gsl_vector_set(x,0,2);
        gsl_vector_set(x,1,2);
	ncalls=GSLrootf(GSLfRos,x,eps);
	printf("GSL hybrids rootfinder takes %d steps before finding the root.\n",ncalls);
